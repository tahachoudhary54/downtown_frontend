      ...
      {seasonalSettings.enabled && (
        <section className={styles.autumnBanner}>
          ...
          <div className={styles.autumnImageWrapper}>
            <Image src={seasonalSettings.image} alt={seasonalSettings.title.replace('\n', ' ')} fill style={{ objectFit: 'cover', objectPosition: 'center' }} />
          </div>
        </section>
      )}
        ...
        <div className={styles.featuresGrid}>
          ...
          <div className={styles.featureCard}>
            <div className={styles.featureIcon}>
              <svg width="35" height="35" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M12 16v-4"></path><path d="M12 8h.01"></path></svg>
            </div>
          ...
          <div className={styles.featureCard}>
            <div className={styles.featureIcon}>
              <svg width="35" height="35" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="3" width="15" height="13"></rect><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"></polygon><circle cx="5.5" cy="18.5" r="2.5"></circle><circle cx="18.5" cy="18.5" r="2.5"></circle></svg>
            </div>
            <h3>Free Shipping</h3>
          ...
          <div className={styles.featureCard}>
            <div className={styles.featureIcon}>
              <svg width="35" height="35" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>
            </div>
